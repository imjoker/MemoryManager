...
int main(int /*i_arg*/, char **)
{
	...
	MemorySystem::InitializeMemorySystem(pHeapMemory, sizeHeap, numDescriptors);
...
bool MemorySystem_UnitTest()
{
	...
	do
	{
		...
		void * pPtr = __malloc__(sizeAlloc);
		...
		// randomly __free__ and/or garbage collect during allocation phase
	...
	// now __free__ those blocks in a random order
	if (!AllocatedAddresses.empty())
	{
		...
		void * pPtr = __malloc__(totalAllocated / 2);
